...
int main(int argc, const char * argv[])
{
    ...
    CharNode *theNode2 = SLCreateNodeWithCharValue("electrostation");
    CharNode *theNode3 = SLCreateNodeWithCharValue("founded");
    CharNode *theNode4 = SLCreateNodeWithCharValue("cheburechek");
